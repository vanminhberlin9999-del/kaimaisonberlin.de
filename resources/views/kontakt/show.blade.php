...
@section('content')
    ...
    <div class="w-full max-w-2xl mx-auto p-6 bg-white dark:bg-gray-900 rounded-lg shadow-lg">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Kontaktiere uns</h2>
    
        <p class="text-gray-700 dark:text-gray-300 mb-6">
            Hast du Fragen oder möchtest du eine Reservierung vornehmen? Fülle das Formular aus und wir melden uns so schnell wie möglich!
        </p>
        ...
        <form action="#" method="POST" class="space-y-4">
            ...
            <div>
                <label class="block text-gray-700 dark:text-gray-300 mb-1">Nachricht</label>
