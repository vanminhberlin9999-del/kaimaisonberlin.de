<footer>
    ...
    <div class="footer-container mx-auto flex flex-col sm:flex-row max-w-7xl items-center justify-between text-white p-6">
        ...
        <div class="w-full sm:w-1/4 mb-6 sm:mb-0">
            <p>
                <span class="mb-2">Instagram</span>
                <a href="https://www.instagram.com/kaimaisonberlin/" target="_blank" class="hover:text-pink-800">
                    <object type="image/svg+xml" data="/images/footer/Instagram_logo_2016.svg" class="ig-svg">Your browser does not support SVG</object>
                </a>
            </p>
        </div>
        ...
        <div class="w-full sm:w-1/4">
            <p>© 2025 Kai Maison. All Rights Reserved.</p>
            <p>Website by <a href="https://asiamoin.com" class="website text-underline" target="_blank">Asia Moin</a></p>
        </div>
    </div>
