...
return [
    ...
    'introduce' => [
        ...
        'meaning_2'   => 'the French word for house, unite here to create an ode to love and giving amidst the endless flow of life.',
    ...
    'press_section' => [
        'title' => 'In the Press',
        'title_1' => 'Title 1',
        'desc_1' => "This is a short description of the first item",

        'title_2' => 'Title 2',
        'desc_2' => "This is a short description of the second item",
